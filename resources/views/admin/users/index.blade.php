...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
                ...
                @if(strtolower(auth()->user()->email) == "abdullah@yahoo.com")
                <li class="nav-item">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('map') }}">
                        <i class="ni ni-pin-3 text-orange"></i> {{ __('Vedioes') }}
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('map') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-circle-08 text-pink"></i> {{ __('login') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @else<a class="dropdown-item" href="{{route('profile.edit')}}">{{__('Edit')}}</a>
                                @endif
    </div>
    </div>
    </td>
